...
storiesOf('MessageContainer', module)
  ...
  .add('MessageContainer Error Message', () => <MessageContainer message={errorMessage} />)
  .add('ProductDisplayItemMain Warning Message', () => <MessageContainer message={warningMessage} />)
  .add('ProductDisplayItemMain Dark Message', () => <MessageContainer message={darkMessage} />);
