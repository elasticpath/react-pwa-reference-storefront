...
export function mockCountryDataAPI() {
  ...
  fetchMock
    ...
    .mock(
      ...
      '/cortex/geographies/vestri/countries?zoom=countries:element,countries:element:regions,countries:element:regions:element,element,element:regions,element:regions:element',
