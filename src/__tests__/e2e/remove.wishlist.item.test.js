...
describe('Wishlist', () => {
  test('Remove wishlist item', async () => {
    ...
    const CART_LINEITEM = '#cart_lineitem_VESTRI_MODEL_S_RED_BRAKE_CALIPER';
    const REMOVE_FROM_WISHLIST_BUTTON = '#cart_lineitem_VESTRI_MODEL_S_RED_BRAKE_CALIPER .btn-cart-removelineitem';
    ...
    const element = await page.$(CART_LINEITEM);
