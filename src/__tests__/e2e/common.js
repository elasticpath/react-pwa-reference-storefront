...
export async function loginUserRegister(page, user) {
...
export async function addProductToCart(page, productCategory, productSubCategory, productName) {
...
export async function registerUser(page, userInfo) {
...
export async function addPaymentMethod(page, paymentMethod) {
...
export async function addAddress(page, address) {
