...
const LOGIN_USERNAME_INPUT = 'input[id="login_modal_username_input"]';
const LOGIN_PASSWORD_INPUT = 'input[id="login_modal_password_input"]';
const LOGIN_BUTTON = 'button[id="login_modal_login_button"]';
