...
class ProductListPaginationBottom extends React.Component {
    ...
    <div className="pagination-container">
        ...
        <div className="pagination-navigation-container">
            <button className="btn-pagination btn-pagination-prev pagination-link pagination-link-disabled" onClick={() => this.clickedPaginationPrevious(paginationPreviousLink)} id="category_items_listing_pagination_previous_bottom_link" data-i18n="category.prev"> <span className="icon"></span>Previous</button>
...
<Link to={"/category/" + encodeURIComponent(paginationNextLink)} className="nav-item" id="category_items_listing_pagination_next_bottom_link" role="button">Next<span className="icon"></span></Link>

            <button className="btn-pagination btn-pagination-next pagination-link pagination-link-disabled" id="category_items_listing_pagination_next_bottom_link" data-i18n="category.next">Next<span className="icon"></span></button>
        </div>
    </div>
    </div>);}
else {
