              ...
              <form id="login_modal_form" onSubmit={this.loginRegisteredUser}>
                ...
                <div className="form-group action-row">
                  ...
                  <div className="form-input btn-container">
                    <button className="vestri-btn primary" id="login_modal_login_button" data-cmd="login" data-toggle="collapse" data-target=".navbar-collapse" type="submit">
                      {intl.get('login')}
                    </button>
                    <Link to="/registration">
                      <button className="vestri-btn" id="login_modal_register_button" data-toggle="collapse" data-target=".navbar-collapse" type="button" onClick={AppModalLoginMain.registerNewUser}>
                        {intl.get('register')}
                      </button>
                    </Link>
                  </div>
