                        ...
                        <div data-region="profilePersonalInfoRegion" style={{ display: 'block' }}>
                            <div>
                                ...
                                <dl className="profile-personal-info-container container">
                                    <dt className="profile-personal-info-label" data-el-label="profile.firstName">First Name:</dt>
                                    <dd className="profile-personal-info-value" id="profile_personal_info_givenName" data-el-value="givenName">{this.state.profileData['given-name']}</dd>
                                    <dt className="profile-personal-info-label" data-el-label="profile.lastName">Last Name:</dt>
                                    <dd className="profile-personal-info-value" id="profile_personal_info_familyName" data-el-value="familyName">{this.state.profileData['family-name']}</dd>
                                </dl>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td data-el-value="purchase.number" className="profile-purchase-number">
                                                <a href="#purchaseDetails/https%3A%2F%2Fforrester.epdemos.com%2Fcortex%2Fpurchases%2Fvestri%2Fgiydanjt%3D">20053</a>
                                            </td>
                                            <td data-el-value="purchase.date" className="profile-purchase-date">June 21, 2018 4:26:39 PM</td>
                                            <td data-el-value="purchase.total" className="profile-purchase-total">$1,181.42</td>
                                            <td data-el-value="purchase.status" className="profile-purchase-status">In progress</td>
                                        </tr>
                                        <tr>
                                            <td data-el-value="purchase.number" className="profile-purchase-number">
                                                <a href="#purchaseDetails/https%3A%2F%2Fforrester.epdemos.com%2Fcortex%2Fpurchases%2Fvestri%2Fgiydanjs%3D">20052</a>
                                            </td>
                                            <td data-el-value="purchase.date" className="profile-purchase-date">June 21, 2018 12:48:28 PM</td>
                                            <td data-el-value="purchase.total" className="profile-purchase-total">$1,071.19</td>
                                            <td data-el-value="purchase.status" className="profile-purchase-status">In progress</td>
                                        </tr>
                                    </tbody>
                                </table>
