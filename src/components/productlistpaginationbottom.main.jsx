              ...
              ? (
                <div className="pagination-navigation-container">
                  {this.state.paginationPreviousLink !== ''
                    ? (
                      <Link to={`/category/${encodeURIComponent(this.state.paginationPreviousLink)}`} className="btn-pagination btn-pagination-prev pagination-link pagination-link-disabled" id="category_items_listing_pagination_previous_bottom_link" role="button">
                        <span className="icon" />
                        Previous
                      </Link>
                    )
                  ...
                  {this.state.paginationNextLink !== ''
                    ? (
                      <Link to={`/category/${encodeURIComponent(this.state.paginationNextLink)}`} className="btn-pagination btn-pagination-next pagination-link pagination-link-disabled" id="category_items_listing_pagination_next_bottom_link" role="button">
                        Next
                        <span className="icon" />
                      </Link>
                    )
