          ...
          return (
            <div className="radio">
              <label htmlFor={`cart-selection-option${option.optionNum}`} className="custom-radio-button">
                <input id={`cart-selection-option${option.optionNum}`} type="radio" value={option.optionNum} checked={selectedCart === `${option.optionNum}`} onChange={this.handleOptionChange} />
