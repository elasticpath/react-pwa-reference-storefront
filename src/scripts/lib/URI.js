...
(function (root, factory) {
    ...
    if (typeof exports === 'object') {
        // Node
        module.exports = factory(require('./scripts/lib/punycode'), require('./scripts/lib/IPv6'), require('./scripts/lib/SecondLevelDomains'));
    } else if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define(['scripts/lib/punycode', 'scripts/lib/IPv6', 'scripts/lib/SecondLevelDomains'], factory);
    } else {
