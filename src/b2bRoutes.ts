...
export default function b2bRoutes() {
  /** All B2B Routes */
  const Accounts = import(/* webpackChunkName: "Accounts" */ './containers/b2b/Accounts');
  ...
  return [{
    ...
    component: lazy(() => AccountMain),
  }, {
    path: '/account/requisition-list-item/:uri',
    exact: true,
    component: lazy(() => RequisitionPageMain),
  }, {
    path: '/account',
    ...
    routes: [
      ...
      },
      {
        ...
        exact: true,
        component: lazy(() => RequisitionList),
      },
      {
        path: '/account/quotes',
        render: () => 'Quotes',
