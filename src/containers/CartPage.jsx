...
const zoomArray = [
  ...
  'defaultcart:lineitems:element:dependentoptions',
  'defaultcart:lineitems:element:dependentoptions:element',
  'defaultcart:lineitems:element:dependentoptions:element:addtocartform',
  'defaultcart:lineitems:element:dependentoptions:element:availability',
  'defaultcart:lineitems:element:dependentoptions:element:definition',
  'defaultcart:lineitems:element:dependentoptions:element:code',
