...
class AccountDetails extends React.Component<RouteComponentProps<AccountMainRouterProps>, AccountMainState> {
  ...
  async getAccountData(accountUri) {
    ...
    if (res) {
      this.setState({
        accountData: res, isLoading: false,
      });
    }
  }
    ...
    return ([
      <div>
        <div className="title">
          ...
          <span className="edit-button">{intl.get('edit')}</span>
        </div>
        ...
        <div className="account-data-container">
          <ul className="account-data-list">
            <li>
              <span className="row-name">Incorporating Date</span>
              <span className="row-value">Data Name</span>
            </li>
            <li>
              <span className="row-name">Estimated Annual Revenue</span>
              <span className="row-value">Data Number</span>
            </li>
            <li>
              <span className="row-name">Credit Limit</span>
              <span className="row-value">Data Number</span>
            </li>
            <li>
              <span className="row-name">Stock Ticker Symbol</span>
              <span className="row-value">Data Fax</span>
            </li>
            <li>
              <span className="row-name">Description</span>
              <span className="row-value">Data Status</span>
            </li>
            <li>
              <span className="row-name">Incorporation Date</span>
              <span className="row-value">Data Name</span>
            </li>
            <li>
              <span className="row-name">Website URL</span>
              <span className="row-value">Data Name</span>
            </li>
            <li>
              <span className="row-name">Sale Rep</span>
              <span className="row-value">Data Name</span>
            </li>
          </ul>
        </div>
