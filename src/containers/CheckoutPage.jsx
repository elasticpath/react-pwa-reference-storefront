          ...
          return (
            <div key={`shippingAddress_${Math.random().toString(36).substr(2, 9)}`}>
              ...
              <div className="address-btn-cell">
                {/* eslint-disable-next-line max-len */}
                <button className="vestri-btn small checkout-edit-address-btn" type="button" onClick={() => { this.editAddress(shippingAddress.self.uri); }}>
                  {intl.get('edit')}
                </button>
                {/* eslint-disable-next-line max-len */}
                <button className="vestri-btn small checkout-delete-address-btn" type="button" onClick={() => { this.handleDelete(shippingAddress.self.uri); }}>
                  {intl.get('delete')}
                </button>
              </div>
            </div>
      ...
      return (
        <div data-region="shippingAddressesRegion" style={{ display: 'block' }}>
          <div>
            ...
            <button className="vestri-btn primary wide checkout-new-address-btn" type="button" onClick={() => { this.newAddress(); }}>
        ...
        billingAddresses.map((billingAddr) => {
          ...
          return (
            <div key={`billingAddress_${Math.random().toString(36).substr(2, 9)}`}>
              ...
              <div className="address-btn-cell">
                {/* eslint-disable-next-line max-len */}
                <button className="vestri-btn small" type="button" onClick={() => { this.editAddress(billingAddr.self.uri); }}>
                  {intl.get('edit')}
                </button>
                {/* eslint-disable-next-line max-len */}
                <button className="vestri-btn small" type="button" onClick={() => { this.handleDelete(billingAddr.self.uri); }}>
                  {intl.get('delete')}
                </button>
              </div>
            </div>
            ...
            <div key={`paymentMethod_${Math.random().toString(36).substr(2, 9)}`}>
              ...
              {deletable && (
                <div className="payment-btn-cell">
                  <button className="vestri-btn small" type="button" onClick={() => { this.handleDelete(payment.self.uri); }}>
                    Delete
                  </button>
                </div>
              )}
  ...
  renderPaymentSelector() {
    return (
      <div>
        ...
        <button className="vestri-btn primary wide checkout-new-payment-btn" type="button" onClick={() => { this.newPayment(); }}>
              ...
              <div>
                <div className="checkout-sidebar-inner">
                  ...
                  <div data-region="checkoutActionRegion" className="checkout-submit-container" style={{ display: 'block' }}>
                    <button className="vestri-btn primary wide btn-cmd-submit-order" type="button" disabled={messages[0]} onClick={() => { this.reviewOrder(); }}>
