...
export default class EditAssociate extends React.Component<EditAssociateProps, EditAssociateState> {
  ...
  render() {
    const {
      associateEmail, handleClose, isOpen, accountName,
    } = this.props;
    ...
    return (
      ...
      >
        ...
        <div className="dialog-content">
          <div className="am-columns">
            <div className="am-field-editor">
              ...
              <input className="field-editor-input" disabled value={associateEmail} />
            </div>
            <div>
        ...
        <div className="dialog-footer">
          ...
          <button className="upload" type="button" onClick={() => this.handleSaveClicked()}>
            {intl.get('save')}
          </button>
        </div>
        {isLoading ? (
