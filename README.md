...
4. Run a Production Docker Image:
    ...
    2. In the `docker-compose.yaml` file, update the following parameters:
        ...
        * `$CORTEX_API_SCOPE` with the name of the store from which Cortex retrieves data.
    3. Run the following Docker command to start the Docker container created for the Docker image:<br/>
