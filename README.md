...
|`b2b.eamAPI.pathForProxy`| Optional| String| The path to which the [Webpack](https://webpack.js.org/) proxy routes the Cortex calls from the storefront to the publicly hosted EAM service. This value is a URL that consists of hostname and port of a running instance of Cortex for EAM. Leave this field blank to disable proxy.|
|`b2b.keyCloak.callbackUrl`| Optional| String| The URL which will be passed to KeyCloak and redirected to upon successful login.|
|`b2b.keyCloak.loginRedirectUrl`| Optional| String| The KeyCloak login URL.|
|`b2b.keyCloak.logoutRedirectUrl`| Optional| String| The KeyCloak logout URL.|
|`b2b.keyCloak.client_id`| Optional| String| The ID of the client configured in Keycloak.|
...
**Note:** If configuring the storefront as a B2B instance, please see the documentation provided [REACT PWA Reference Storefront Documentation B2B](https://elasticpath.github.io/react-pwa-reference-storefront/documentation/b2b/).
